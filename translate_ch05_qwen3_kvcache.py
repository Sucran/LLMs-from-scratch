...
def translate_notebook(input_file, output_file):
    ...
    translations = {
        ...
        "**This notebook is similar to [standalone-qwen3.ipynb](standalone-qwen3.ipynb) except that it adds a KV cache for better compute efficiency. See the comparison tables in the [README.md](README.md) for more information about the performance comparisons. For more information on KV caching, see my [Understanding and Coding the KV Cache in LLMs from Scratch](https://magazine.sebastianraschka.com/p/coding-the-kv-cache-in-llms) article.**": "**本笔记本类似于 [standalone-qwen3.ipynb](standalone-qwen3.ipynb)，但添加了 KV 缓存以提高计算效率。有关性能比较的更多信息，请参阅 [README.md](README.md) 中的比较表。有关 KV 缓存的更多信息，请参阅我的文章 [Understanding and Coding the KV Cache in LLMs from Scratch](https://magazine.sebastianraschka.com/p/coding-the-kv-cache-in-llms)。**",
...
if __name__ == "__main__":
    print("Reading ch05/11_qwen3/standalone-qwen3-plus-kvcache.ipynb...")
    translate_notebook('ch05/11_qwen3/standalone-qwen3-plus-kvcache.ipynb', 'ch05/11_qwen3/standalone-qwen3-plus-kvcache_zh.ipynb')
    print("Done.")
