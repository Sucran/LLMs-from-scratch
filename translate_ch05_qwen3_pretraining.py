...
input_file = "ch05/14_ch05_with_other_llms/ch05-qwen3.ipynb"
output_file = "ch05/14_ch05_with_other_llms/ch05-qwen3_zh.ipynb"
...
translations = {
    ...
    "# Chapter 5 Bonus: Pretraining Qwen3 on Unlabeled Data": "# 第 5 章额外内容：在未标记数据上预训练 Qwen3",
    "- This notebook plugs in the [Qwen3 0.6B from-scratch](../11_qwen3/standalone-qwen3.ipynb) model into (the pretraining portion) of chapter 5": "- 本笔记本将 [Qwen3 0.6B from-scratch](../11_qwen3/standalone-qwen3_zh.ipynb) 模型插入到第 5 章的（预训练部分）",
    "- This is to show how to use Qwen3 0.6B as a drop-in replacement for the GTP-2 model used in [chapter 5](../01_main-chapter-code/ch05.ipynb)": "- 这是为了展示如何使用 Qwen3 0.6B 作为 [第 5 章](../01_main-chapter-code/ch05_zh.ipynb) 中使用的 GPT-2 模型的直接替代品",
    "## 5.1 Evaluating generative text models": "## 5.1 评估生成文本模型",
    "- No code": "- 无代码",
    "### 5.1.1 Using Qwen3 to generate text": "### 5.1.1 使用 Qwen3 生成文本",
