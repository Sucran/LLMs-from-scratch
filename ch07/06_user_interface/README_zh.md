# 构建与指令微调后的 GPT 模型交互的用户界面



此奖励文件夹包含用于运行类似 ChatGPT 的用户界面以与第 7 章中的指令微调 GPT 模型进行交互的代码，如下所示。
...
此文件加载并使用我们在第 7 章中生成的 GPT-2 权重。这要求你首先执行 [`../01_main-chapter-code/ch07.ipynb`](../01_main-chapter-code/ch07.ipynb) 文件。
