...
trans_map = {
    ...
    "This notebook contains minimal code to load the finetuned model that was created and saved in chapter 6 via [ch06.ipynb](ch06.ipynb).": "本笔记本包含最少的代码，用于加载在第 6 章中通过 [ch06.ipynb](ch06.ipynb) 创建并保存的微调后的模型。"
}
...
if __name__ == "__main__":
    input_file = "/Users/richard/Git/LLMs-from-scratch/ch06/01_main-chapter-code/load-finetuned-model.ipynb"
    output_file = "/Users/richard/Git/LLMs-from-scratch/ch06/01_main-chapter-code/load-finetuned-model_zh.ipynb"
